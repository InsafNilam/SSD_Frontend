            ...
            <Dialog open={isAdd} onClose={handleAddClose} keepMounted maxWidth={'md'} aria-labelledby="responsive-dialog-title">
                ...
                <div className="form-group mb-3">
                    ...
                    <div class="input-group mb-4">
                        <input type="text" name="username" className="form-control" placeholder="Enter User Name" value={description} onChange={e=>{
                ...
                <DialogActions>
                    <div>
                        <input type='submit' className='btn btn-danger m-2' onClick={()=>{
                            authAxios.delete(`/file/${filename}`).then(res=>{
                ...
                <DialogActions>
                    <div>
                        <input type='submit' className='btn btn-success m-2' onClick={()=>{
                            authAxios.get(`/file/${filename}`).then(res=>{
                                if(res){
